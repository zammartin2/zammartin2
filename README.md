...
<p align="center">
  <a href="https://github.com/zammartin2">
    <img src="https://img.shields.io/badge/GitHub-zammartin2-181717?style=for-the-badge&logo=github" alt="GitHub" />
  </a>
...
<p>
  <a href="https://www.npmjs.com/package/@fab-orbita/shield">
    <img src="https://img.shields.io/npm/v/@fab-orbita/shield.svg?style=flat-square&logo=npm&color=cb3837" alt="npm version" />
  </a>
...
- Rate limiting
- Обнаружение XSS, SQL Injection, NoSQL Injection, LDAP Injection
- Метрики и отчёты
...
- совместимость с npm-командами;
- кеширование пакетов;
- управление организациями и командами;
- роли и права доступа;
- foundation для enterprise package infrastructure.

**Стек:** NestJS, TypeScript, PostgreSQL, Redis, MinIO, Docker, Kubernetes

**Ссылка:** [fab.devorbit.ru](https://fab.devorbit.ru)
...
- 🧠 **DevOrbit Academy** — обучение, AI-помощник, сертификация
- 🔬 **R&D-проекты** — прототипы на стыке AI, инженерии и инфраструктуры
- 💼 **Карьера и B2B** — инструменты для компаний и команд
- 🏛️ **Сообщество** — форум, репутация, модерация
- 💰 **Финансовые сервисы** — подписки, кошелёк, бухгалтерия

**Стек:** NestJS, TypeScript, PostgreSQL, Redis, WebSocket, Docker, Ollama, Jest

**Ссылка:** [devorbit.ru](https://devorbit.ru)
...
- AI-рассуждение и генерация гипотез;
- инженерные пайплайны;
- научные вычисления;
- цифровые двойники;
- XR-интерфейсы;
- интеграции с CAD/PLM-системами.

**Стек:** TypeScript, NestJS, Go, Vue 3, Three.js, PostgreSQL, Kafka, Kubernetes

**Ссылка:** [uaip.ru](https://uaip.ru)

---

### ✈️ Aerounion

Коммерческие проекты для авиации, телематики и управления офисными процессами.
...
- ERP-модули;
- управление сотрудниками, задачами и внутренними процессами.
...
| ⚙️ **DevOps & Infra** | Docker, Kubernetes, monitoring, scaling, production setup |
...
- **Enterprise-компаниям** — строю платформы, которые масштабируются
- **Исследовательским командам** — создаю инфраструктуру для R&D
